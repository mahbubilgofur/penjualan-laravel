...
<div class="page-heading">
    ...
    <table border="1">
    <form action="/tambahdate" method="POST">
      @csrf
            <div class="row">
                <div class="col-4">
               <div class="mb-3">
            <label for="" class="form-label">id_dt</label>
            <input type="text" class="form-control" name="id_dt">
        </div>
         <div class="mb-3">
          ...
          <div class="mb-3">
           <label for="" class="form-label">jml</label>
  ...
  <tbody>
    @foreach($detailtrx as $detailtrx)
    <tr class="isi">
        <td class="bg-info">{{ $loop->iteration }}</td>
        <td class="bg-info">{{ $detailtrx->id_dt }}</td>
         <td class="bg-info">{{ $detailtrx->id_transaksi }}</td>
          <td class="bg-info">{{ $detailtrx->id_barang }}</td>
           <td class="bg-info">{{ $detailtrx->jml }}</td>
            <td class="bg-info">{{ $detailtrx->total }}</td>
        <td class="bg-info"><a href="/editdate/{{ $detailtrx->id }}" class="btn btn-warning">EDIT</a>
          <a href="/hapusc/{{ $detailtrx->id }}" class="btn btn-danger">DELETE</a>
        </td>
    </tr>
    @endforeach
  </tbody>
