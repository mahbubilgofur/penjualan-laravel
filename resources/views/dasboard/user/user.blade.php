...
<div class="page-heading">
   ...
   <table border="1">
    <form action="/editdatas/{{ $username->id }}" method="POST">
      @csrf
            <div class="row">
                <div class="col-4">
               <div class="mb-3">
            <label for="" class="form-label">id_transaki</label>
            <input type="text" class="form-control" name="id_user" value="{{ $username->id_user }}">
        </div>
         <div class="mb-3">
           <label for="" class="form-label">tgl_trx</label>
           <input type="date" class="form-control" name="nama" value="{{ $username->nama }}">
        </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
           ...
           <input type="text" class="form-control" name="password" value="{{ $username->password }}">
        </div>
          <div class="mb-3">
           <label for="" class="form-label">bayar</label>
           <input type="text" class="form-control" name="akses" value="{{ $username->akses }}">
        </div>
