...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">         
   <table border="1">
    <form action="/tambahan" method="POST">
      @csrf
  ...
  <tbody>
    ...
    <tr class="isi">
        ...
        <td class="bg-info">{{ $jenis->id_jenis }}</td>
         <td class="bg-info">{{ $jenis->nama_jenis }}</td>
        <td class="bg-info"><a href="/edit/{{ $jenis->id }}" class="btn btn-warning">EDIT</a>
          <a href="/hapusb/{{ $jenis->id }}" class="btn btn-danger">DELETE</a>
        </td>
    </tr>
    @endforeach
  </tbody>
