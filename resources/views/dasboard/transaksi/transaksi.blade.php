...
<div class="page-heading">
   ...
   <table border="1">
    <form action="/editan/{{ $transaksi->id }}" method="POST">
      @csrf
                   <div class="row">
                <div class="col-4">
               <div class="mb-3">
            <label for="" class="form-label">id_transaki</label>
            <input type="text" class="form-control" name="id_transaksi" value="{{ $transaksi->id_transaksi }}">
        </div>
         <div class="mb-3">
         ...
         <div class="mb-3">
           ...
           <input type="text" class="form-control" name="id_barang" value="{{ $transaksi->id_barang }}">
        </div>
          <div class="mb-3">
