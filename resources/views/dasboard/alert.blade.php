...
<div class="page-heading">
  ...
  <tbody>
    ...
    <tr class="isi">
        ...
        <td class="bg-info">{{ $barang->nama_barang }}</td>
        <td class="bg-info">{{ $barang->harga }}</td>
         <td class="bg-info">{{ $barang->stok }}</td>
        <td class="bg-info"><a href="/coba/{{ $barang->id }}" class="btn btn-warning">EDIT</a>
          <a href="/hapusa/{{ $barang->id }}" class="btn btn-danger">DELETE</a>
        </td>
    </tr>
    @endforeach
  </tbody>
