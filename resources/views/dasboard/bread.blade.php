...
<div class="page-heading">
    ...
    <form action="/tambahdata" method="POST">
      @csrf
         ...
         <div class="mb-3">
           <label for="" c lass="form-label">id_barang</label>
  ...
  <tbody>
    ...
    <tr class="isi">
        ...
        <td class="bg-info">{{ $transaksi->id_transaksi }}</td>
         <td class="bg-info">{{ $transaksi->tgl_trx }}</td>
          <td class="bg-info">{{ $transaksi->id_user }}</td>
            <td class="bg-info">{{ $transaksi->nama_barang }}</td>
           <td class="bg-info">{{ $transaksi->total_bayar }}</td>
            <td class="bg-info">{{ $transaksi->bayar }}</td>
        <td class="bg-info"><a href="/editan/{{ $transaksi->id }}" class="btn btn-warning">EDIT</a>
          <a href="/hapus/{{ $transaksi->id }}" class="btn btn-danger">DELETE</a>
        </td>
    </tr>
    @endforeach
  </tbody>
